<?php include(APPPATH.'Views/templates/side-nav.php'); ?>
    ...
    <div class="container-fluid">
        ...
        <?php
                ...
                echo  '<div class="">Student profile created successfully!</div><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href='.base_url()."/dashboard/student/".$_GET["_id"].'><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;View profile</a>';
                echo '</div>';
                }
